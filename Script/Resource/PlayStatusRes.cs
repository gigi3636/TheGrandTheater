...
public partial class PlayStatusRes : Resource
{
    public enum PlayStatusEnum 
    {
        ...
        Act1Gameplay,// Leve de rideau Explique la premiere epreuve a faire , partir vers le chateau 2 Gameplay , 1 phrase durant la run 
        Act1Entracte, // Fermeture de rideau petite conclusion de la run 3
        Act2Gameplay,// Leve de rideau Explique la deuxieme epreuve a faire , survivre la nuit sur le camp de fortune  Gameplay , 1 phrase durant la run en fonction de ce qui se passe 4
        Act2Entracte, // Fermeture de rideau petite conclusion de la run 5
        Act3Gameplay,// Leve de rideau Explique la troisieme epreuve a faire , grimper le chateau 6 Gameplay, 1 phrase durant la run 6
